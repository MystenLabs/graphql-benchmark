...
export async function benchmark_connection_query(
	...
	testFn: (cursor: PaginationParams) => Promise<{ pageInfo: PageInfo | undefined; variables: any }>,
): Promise<Report> {
...
export function report<T>(variables: T, cursors: string[], metrics: Metrics): Report {
